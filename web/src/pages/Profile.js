                  ...
                  {isEditingWebsite ? (
                    ...
                    <>
                      <a href={userProfile.social.website} target="_blank" rel="noopener noreferrer" className={`flex items-center space-x-2 ${currentTheme.socialIcon} p-2`}>
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-1.31 17.625c-.18.12-.43.12-.61 0l-4.5-3a.75.75 0 01-.27-.56v-4a.75.75 0 01.27-.56l4.5-3a.75.75 0 01.61 0l4.5 3a.75.75 0 01.27.56v4a.75.75 0 01-.27.56l-4.5 3zm7.5-9a.75.75 0 01-.27.56v4a.75.75 0 01-.27.56l-4.5 3a.75.75 0 01-.61 0l-4.5-3a.75.75 0 01-.27-.56v-4a.75.75 0 01.27-.56l4.5-3a.75.75 0 01.61 0l4.5 3a.75.75 0 01.27.56z"/>
                        </svg>
